...
//    DLL = div & 0xff;
//
//    simWrite(IER1, 0x80);//reset uart1
//
//    simWrite(LCR1, 0x80);//LCR1 = 0x80;
//    simWrite(DLL1, DLL);//DLL1 = DLL;
//    simWrite(DLM1, DLM);//DLM1 = DLM;
//
...
//    simWrite(IER1, 0x03);//IER1 = 0x01;//only open recv interrupt
