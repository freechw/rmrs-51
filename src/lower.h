...
extern data unsigned char lowerCanTrans_Flag;//set to 1 when read all the recommand meters
extern data unsigned char lowerReading_Flag;//set to 1 when read meter cycle reading......
